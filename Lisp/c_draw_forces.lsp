...
(defun c:TP_draw_forces( / old_env_vars ins_pt force_data filename
	...
	(setq ln_tension "TRUSSPY_forces_T")
	(setq ln_compression "TRUSSPY_forces_C")
	(setq ln_zero "TRUSSPY_forces_Z")
	...
	(setq filename (strcat filename ".frc"))	
